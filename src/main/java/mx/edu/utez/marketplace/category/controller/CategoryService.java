...
public class CategoryService {
    //Se va a desarrollar el código de lógica de negocio
    @Autowired
    CategoryRepository categoryRepository; //INICIALIZAR EL REPOSITORIO
    ...
    public ResponseEntity<Message> findById(long id){
        ...
        return new ResponseEntity<>(new Message("la categoria no existe", true, categoryRepository.findById(id)), HttpStatus.BAD_REQUEST);
    }
